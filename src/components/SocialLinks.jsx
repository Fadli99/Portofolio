...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/fadli-aziz-setiawan/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@f_a_setiawan",
    icon: Instagram,
    url: "https://www.instagram.com/f_a_setiawan/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@Fadli Aziz S",
    icon: Youtube,
    url: "https://www.youtube.com/@FadliAzizS",
    color: "#FF0000",
